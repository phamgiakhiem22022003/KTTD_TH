...
public class Page_TaoHocKy {
	...
	// ngày bắt đầu
	private By ByDropDown_Ngay = By.xpath("//html/body/div[7]/div[2]/form/div[5]/input[2]");
	private By ByXoa_Ngay = By.xpath("/html/body/div[4]/div[1]/div/div/div/input");
	private By ByNhap_Nam = By.xpath("/html/body/div[9]/div[1]/div/div/div/input");
	...
	public Page_TaoHocKy (WebDriver driver) {
		this.driver = driver;
	}
	
	public void TaoHK(String inHK, String inNam) {
