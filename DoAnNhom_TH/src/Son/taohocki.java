...
//addTerm
    public static void addTerm() throws InterruptedException {
        Thread.sleep(1000);
        driver.findElement(By.xpath("/html/body/div[3]/div[2]/form/div[1]/input")).sendKeys("999");
    }
//select year begins
    public static void selectYearBegins() throws InterruptedException {
        Thread.sleep(1000);
...
//select year ends
    public static void selectYearEnds() throws InterruptedException {
        Thread.sleep(1000);
...
//select week
    public static void selectWeek() throws InterruptedException {
...
//select days
    public static void selectDay() throws InterruptedException {
