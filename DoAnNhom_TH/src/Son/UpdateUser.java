...
public class UpdateUser {
	...
	public void find() throws InterruptedException {
		...
		// Tìm và nhập "ABCD" vào ô tìm kiếm có xpath là
		// "//*[@id=\"tblUser_filter\"]/label/input"
		WebElement sendKey = driver.findElement(By.xpath("//*[@id=\"tblUser_filter\"]/label/input"));
		sendKey.sendKeys("ABCD");
		Thread.sleep(2000);

		// Tìm và click vào nút "Sửa" có xpath là
		// "/html/body/div[2]/div[2]/div[3]/div/section/div[2]/div[2]/div/div/table/tbody/tr/td[7]/a[1]"
		WebElement Sua = driver.findElement(By
				.xpath("/html/body/div[2]/div[2]/div[3]/div/section/div[2]/div[2]/div/div/table/tbody/tr/td[7]/a[1]"));
		Sua.click();
		Thread.sleep(5000);

		// Click vào dropdown có xpath là
		// "/html/body/div[3]/div[2]/form/div[5]/div/span/span[1]/span/span[1]"
		...
		// Click vào một phần tử trong dropdown có xpath là
		// "/html/body/div[3]/div[2]/form/div[5]/div/span[2]/span/span[2]/ul/li["+Num+"]"
		driver.findElement(By.xpath("/html/body/div[3]/div[2]/form/div[5]/div/span[2]/span/span[2]/ul/li[" + Num + "]"))
				.click();
		Thread.sleep(2000);

		// Click vào nút "Lưu" có xpath là
		// "/html/body/div[3]/div[2]/form/div[7]/button[2]"
	...
	public void afterTest() throws InterruptedException {
		...
		// Lấy và in ra thông tin đã cập nhật từ phần tử có xpath là
		// "/html/body/div[2]/div[2]/div[3]/div/section/div[2]/div[2]/div/div/table/tbody/tr/td[6]/span"
		WebElement titlElement = driver.findElement(By
				.xpath("/html/body/div[2]/div[2]/div[3]/div/section/div[2]/div[2]/div/div/table/tbody/tr/td[6]/span"));
