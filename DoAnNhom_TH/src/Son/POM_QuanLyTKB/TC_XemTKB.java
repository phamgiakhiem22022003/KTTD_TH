...
public class TC_XemTKB {
    ...
    public void XemThoiKhoaBieu() throws InterruptedException {
		...
		Page_XemTKB homePage = new Page_XemTKB(driver);
        homePage.navigateToSchedule();
    }

    @Test(priority = 2)
    public void XemTKB() throws InterruptedException {
    	
    	Page_XemTKB schedulePage = new Page_XemTKB(driver);
        schedulePage.ChoiceHocKy("997");
        schedulePage.ChoiceGiangVien("Võ Anh Tiến");
        schedulePage.ChoiceTuan("Tuần 16");
    }
