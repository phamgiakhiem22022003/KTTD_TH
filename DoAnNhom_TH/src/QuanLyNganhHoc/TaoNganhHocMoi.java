...
public class TaoNganhHocMoi {
	...
	public void TaoNHMoi() throws InterruptedException {
    	...
    	//nhập mã ngành
    	driver.findElement(By.xpath("/html/body/div[3]/div[2]/form/div[1]/input")).sendKeys("20230242");
    	Thread.sleep(2000);
