...
public class MaNganhSai {
	...
	public void MaNganhBiLoi() throws InterruptedException {
    	...
    	driver.findElement(By.xpath("/html/body/div[3]/div[2]/form/div[1]/input")).sendKeys("Phạm Gia Khiêm");
    	Thread.sleep(2000);
