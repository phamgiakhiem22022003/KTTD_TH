...
public class NamBDvaNamKT_Sai {
	...
	public void selectDay() throws InterruptedException {
		...
		Thread.sleep(1000);
		driver.findElement(By.xpath("/html/body/div[4]/div[1]/div/div/div/input")).sendKeys("2026");
		Thread.sleep(1000);
