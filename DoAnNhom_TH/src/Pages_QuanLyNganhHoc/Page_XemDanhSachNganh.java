...
public class Page_XemDanhSachNganh {
	
	private WebDriver driver;
	
	public Page_XemDanhSachNganh (WebDriver driver) {
        this.driver = driver;
    }
	...
	public void KiemtraTimkiem () throws InterruptedException {
		// Kiểm tra tìm kiếm
		...
		WebElement outputMa = driver.findElement(By.xpath(
				"/html/body/div[2]/div[2]/div[3]/div/section/div/div/div/div[2]/div/div/table/tbody/tr[1]/td[2]"));
		System.out.println("Mã Ngành: " + outputMa.getText()); // In ra thông tin Mã Ngành sau khi tìm kiếm

		Thread.sleep(2000); // Tạm dừng chương trình trong 2 giây để chờ cho các tác vụ tiếp theo hoàn thành

		WebElement outputTen = driver.findElement(By.xpath(
				"/html/body/div[2]/div[2]/div[3]/div/section/div/div/div/div[2]/div/div/table/tbody/tr[1]/td[3]"));
		System.out.println("Tên Ngành: " + outputTen.getText()); // In ra thông tin Tên Ngành sau khi tìm kiếm

		Thread.sleep(2000); // Tạm dừng chương trình trong 2 giây để chờ cho các tác vụ tiếp theo hoàn thành

		WebElement outputTVT = driver.findElement(By.xpath(
				"/html/body/div[2]/div[2]/div[3]/div/section/div/div/div/div[2]/div/div/table/tbody/tr[1]/td[4]"));
		System.out.println("Tên viết tắt: " + outputTVT.getText()); // In ra thông tin Tên viết tắt sau khi tìm kiếm

		Thread.sleep(2000); // Tạm dừng chương trình trong 2 giây để chờ cho các tác vụ tiếp theo hoàn thành

		WebElement outputCTĐT = driver.findElement(By.xpath(
				"/html/body/div[2]/div[2]/div[3]/div/section/div/div/div/div[2]/div/div/table/tbody/tr[1]/td[5]"));
